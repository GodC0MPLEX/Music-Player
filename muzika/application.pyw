...
-------------------------------------------------------------------------------
Description : 
MUZIKA MP3 Player is a python tkinter based music player which you can use to
...
class Player(tk.Frame):
	...
	def create_frames(self):
		...
		self.track.config(width=400,height=800)
